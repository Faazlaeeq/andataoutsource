    ...
    <footer className={styles.footer}>
        ...
        <div className={styles.footerContact}>
          <div className={styles.contactItem}>
            ...
            <div>
              ...
              <br />
              <strong>Backup Office Address:</strong><br />
          ...
          <div className={styles.contactItem}>
            ...
            <a href="mailto:support@andataoutsource.com" className={styles.emailLink}>
      ...
      <div className={styles.footerBottom}>
        <div className={styles.footerBottomInner}>
          <span>© {new Date().getFullYear()} www.andataoutsource.com All rights reserved.</span>
        </div>
      </div>
    </footer>
  );
